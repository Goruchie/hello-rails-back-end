...
>  [Front end app](https://github.com/Goruchie/hello-react-front-end/pull/1)
...
- Example : https://github.dev/Goruchie/hello-rails-back-end
...
Feel free to check the [issues page](https://github.com/Goruchie/hello-rails-back-end/issues).
